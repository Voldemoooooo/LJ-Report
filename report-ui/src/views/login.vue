  ...
  <div class="login_container">
    ...
    >
      <div style="font-size: 20px; line-height: 50px; margin-bottom: 50px">
        LJ-Report由<a href="http://www.anji-plus.com/" target="_blank" style="text-decoration: underline"><b>安吉加加信息技术有限公司</b></a
      ...
      <div style="font-size: 20px; line-height: 50px">
        ...
        <strong style="color: orangered">禁止将LJ-Report产品用于违法违规业务。</strong>
      </div>
